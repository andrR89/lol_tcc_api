...
class HelloLoL(object):
    ...
    def __init__(self):
        ...
        self.url_service = "https://global.api.pvp.net/api/lol/static-data/br/v1.2/champion?api_key=dad3cbe4-23a8-419b-984b-8ba98b134928"
    ...
    def get_all_lores(self):
        try:
            ...
            xxx = simplejson.loads(content.decode("utf-8"))
            ## Pego o Json e Carrego num Dict
            result = champions.load(xxx)
            return result.data
